...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
      ...
      CTL_T(TMUX_PRE), GUI_A,   ALT_S,   CTL_D,   SFT_F,    KC_G,    KC_H,    SFT_J,   CTL_K,   ALT_L,   TD(TD_CLN),KC_QUOT,          KC_ENT,
        KC_LSFT,                 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
        KC_LCTL,     KC_LGUI, KC_LALT,                            KC_SPC,                             TD(TD_TERMINATOR), MO(2),   KC_RCTL,   TT(1)
    ),
    [1] = LAYOUT_60_ansi(
        ...
        KC_MPRV,          KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, NK_TOGG, _______, _______, KC_END,  KC_UP,            KC_MNXT,
