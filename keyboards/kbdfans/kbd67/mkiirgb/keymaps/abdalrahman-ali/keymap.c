...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
 ...
 CTL_T(KC_CAPS), RGB_SPI,  RGB_SPD, _______, _______, _______, _______, _______, _______, _______, _______,  _______,         EEP_RST, KC_PGDN,
    ...
    [_hjkl] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,  _______, _______, _______,                                                       _______, KC_VOLD, DF(_game)
    ),

    [_mods] = LAYOUT_65_ansi_blocker(
        KC_PWR,  _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSPC, KC_DEL,
        KC_TAB,  _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, KC_PGUP,
        TMUX,    _______, _______,  _______, _______, _______, KC_BSPC, KC_END,  KC_HOME,  KC_DEL,  KC_ENT, _______,          _______, KC_PGDN,
        KC_LSFT, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,          KC_RSFT, KC_VOLU, _______,
